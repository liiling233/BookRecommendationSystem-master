...
#--------------------------------------------------------------------------
path = './datasets/BX-CSV-Dump/BX-Users.csv'
...
path = './datasets/BX-CSV-Dump/books.csv'
...
path = './datasets/BX-CSV-Dump/bookrating.csv'
...
Booktuijian = pd.read_csv('datasets/BX-CSV-Dump/booktuijian.csv')
